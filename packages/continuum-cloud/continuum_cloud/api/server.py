...
from continuum_cloud.billing.middleware import BillingMiddleware
from continuum_cloud.billing.metering import UsageMetering, RateLimiter
...
DONATION_NAG_MESSAGE = "Support CONTINUUM! Donate $10 to remove this message: https://buy.stripe.com/test_7sYaEYc3xbgygTx9jibfO00"
...
class DonationNagMiddleware(BaseHTTPMiddleware):
    ...
    async def dispatch(self, request: Request, call_next):
        ...
        # Add nag header to all API responses (FREE tier by default)
        # TODO: Check actual tier from API key when billing is implemented
...
async def websocket_sync_endpoint(
    ...
    **Tenant Isolation:**
    ...
    """
    from continuum_cloud.realtime import WebSocketHandler
