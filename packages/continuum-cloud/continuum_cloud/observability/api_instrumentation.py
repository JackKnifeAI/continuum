...
def instrument_fastapi_app(app, **kwargs):
    ...
    Example:
        ...
        from continuum_cloud.observability.api_instrumentation import instrument_fastapi_app
...
def add_route_span(func: Callable) -> Callable:
    ...
    Example:
        ```python
        from continuum_cloud.observability.api_instrumentation import add_route_span
