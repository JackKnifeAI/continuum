...
def setup_logging(
    ...
    Example:
        ```python
        from continuum_cloud.observability import setup_logging
...
def get_logger(name: str) -> logging.Logger:
    ...
    Example:
        ```python
        from continuum_cloud.observability import get_logger
...
def create_logger(name: str) -> StructuredLogger:
    ...
    Example:
        ```python
        from continuum_cloud.observability import create_logger
