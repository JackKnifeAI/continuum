...
# Global metering instance (should be injected via dependency injection in production)
# For now, we create a singleton instance that can be shared across requests
...
async def get_dashboard_stats(
    ...
    try:
        ...
        # Get API call metering from the usage tracking system
