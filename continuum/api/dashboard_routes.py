...
# Usage metering for tracking API calls
...
async def get_dashboard_stats(
    ...
    try:
        ...
        # Get API call metering from usage tracker
        # This queries the in-memory usage cache maintained by the billing middleware
