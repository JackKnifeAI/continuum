...
# This is injected at startup via dependency injection
_metering_instance: Optional[UsageMetering] = None


def set_metering_instance(metering: UsageMetering) -> None:
    """
    Set the global metering instance (called from server.py at startup).
...
def get_metering_instance() -> UsageMetering:
    ...
    if _metering_instance is None:
        ...
        # This allows tests and standalone usage to work
...
async def get_dashboard_stats(
    ...
    try:
        ...
        # Query API call metering from the global metering instance
