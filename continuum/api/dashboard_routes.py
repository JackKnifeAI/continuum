...
# Shared metering instance for API call tracking
# This instance is separate from the middleware's metering but tracks the same metrics
...
async def get_dashboard_stats(
    ...
    try:
        ...
        # Get API call count for today using the metering system
        # The metering system tracks usage in-memory with periodic flushes
