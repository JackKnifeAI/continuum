...
async def get_dashboard_stats(
    ...
    try:
        ...
        # Query the shared UsageMetering instance (stored in app.state by server.py).
        # BillingMiddleware records every API call against this instance, so
        # get_usage returns the live count for today.
        metering: Optional[UsageMetering] = getattr(request.app.state, "metering", None)
