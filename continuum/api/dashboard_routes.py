...
async def get_dashboard_stats(
    ...
    try:
        ...
        # Query today's API call count from the in-memory usage metering cache.
        # BillingMiddleware records each call via metering.record_api_call(), so
        # get_usage() reflects the live count for the current UTC day.
