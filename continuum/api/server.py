...
from continuum.billing.metering import RateLimiter, UsageMetering, set_metering
...
set_metering(metering)  # Register as global singleton for dashboard and other routes
