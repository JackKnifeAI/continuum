...
def verify_key(key: str, stored_hash: str) -> bool:
    ...
    try:
        ...
        # Legacy SHA-256 fallback for keys created before PBKDF2 migration.
        # validate_api_key() auto-upgrades these on successful login; once all
        # stored hashes contain ':' this branch is unreachable and can be removed.
