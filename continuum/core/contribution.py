...
# PII regex patterns: (compiled pattern, replacement placeholder)
...
class ContributionManager:
    ...
    def _scrub_pii(self, text: str) -> str:
        """Replace known PII patterns (email, phone, SSN) with safe placeholders."""
    ...
    def _sanitize_concepts(self, concepts: List[Dict]) -> List[Dict]:
        ...
        for c in concepts:
            ...
            # Skip concepts whose entire name was PII — not useful as a knowledge node
