...
# PII patterns: match emails and common phone number formats
...
def _scrub_pii(text: str) -> str:
    """Replace PII tokens (emails, phone numbers) with a redaction marker."""
...
class ContributionManager:
    ...
    def _sanitize_concepts(self, concepts: List[Dict]) -> List[Dict]:
        ...
        for c in concepts:
            ...
            desc = _scrub_pii(c["desc"]) if c["desc"] else ""
            clean.append({
                "name": name,
