...
# ---------------------------------------------------------------------------
# PII detection — compiled once at module load for efficiency
# ---------------------------------------------------------------------------
_PII_PATTERNS: List[Tuple[re.Pattern, str]] = [
    # Email addresses
    (re.compile(r'\b[A-Za-z0-9._%+-]+@[A-Za-z0-9.-]+\.[A-Za-z]{2,}\b'), '[EMAIL]'),
    # Phone numbers: +1 (555) 555-5555, 555-555-5555, 555.555.5555, etc.
...
def _scrub_pii(text: str) -> str:
    """Replace PII (emails, phones, SSNs) with safe placeholder tokens."""
