...
class ContributionManager:
    ...
    # Compiled PII patterns — email addresses and common phone number formats.
    ...
    def _redact_pii(self, text: str) -> str:
        """Replace emails and phone numbers in *text* with a placeholder."""
        for pattern in self._PII_PATTERNS:
            text = pattern.sub(self._PII_PLACEHOLDER, text)
        return text
