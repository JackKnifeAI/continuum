...
# PII patterns — replace matches with labelled placeholders before federation upload
...
_PII_RE = [(re.compile(pat), repl) for pat, repl in _PII_PATTERNS]
...
class ContributionManager:
    ...
    def _scrub_pii(self, text: str) -> str:
        """Replace PII patterns (email, phone, SSN, card) with labelled placeholders."""
        for pattern, placeholder in _PII_RE:
