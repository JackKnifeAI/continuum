...
# Compiled PII patterns for fast repeated matching
...
def _redact_pii(text: str) -> str:
    """Replace PII patterns (emails, phones, SSNs) with [REDACTED]."""
...
class ContributionManager:
    ...
    def _sanitize_concepts(self, concepts: List[Dict]) -> List[Dict]:
        ...
        for c in concepts:
            ...
            if name == "[REDACTED]":
                continue  # concept name was itself PII — drop entirely
