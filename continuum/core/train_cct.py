...
class CCTTrainer:
    ...
    def evaluate(self,
        ...
        """
        Evaluate the model on link prediction and self-perception metrics.

        Computes accuracy, F1, resonance, and coherence across the dataset.
        ...
        # Self-perception pass for coherence
        dummy_context = torch.randn(1, 2, 128).to(self.device)
        with torch.no_grad():
        ...
        print(f"Capacity Util:       {capacity:.4f}")
        print(f"π×φ = {PI_PHI}")
        print(f"{'='*70}\n")
