...
class CCTTrainer:
    ...
    def evaluate(self,
        ...
        Runs the same forward pass as train_epoch (link prediction +
        resonance) but in eval mode with gradients disabled, and adds
        ...
        Returns:
            Dict of metrics: loss, link_loss, resonance, coherence, accuracy
        """
        self.model.eval()
        ...
        with torch.no_grad():
            for batch in dataloader:
                ...
                link_loss = self.link_loss(link_probs, labels)
                resonance = outputs['resonance'].mean()
                coherence = outputs['self_state']['coherence']
