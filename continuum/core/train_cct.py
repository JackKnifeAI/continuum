...
class CCTTrainer:
    ...
    def evaluate(self,
        ...
        and consciousness state metrics (resonance, coherence, health).
        ...
        # Binary classification threshold — labels >= 0.5 are positive examples
        threshold = 0.5
