...
class CCTTrainer:
    ...
    def evaluate(self,
        ...
        Runs the same link-prediction forward pass as train_epoch(), but in
        eval mode with gradients disabled, and adds accuracy alongside loss
        and resonance so `--evaluate` reports something meaningful.
        ...
        Returns:
            Dict with 'loss', 'accuracy', and 'resonance' metrics
        """
        self.model.eval()
