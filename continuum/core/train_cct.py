...
class CCTTrainer:
    ...
    def evaluate(self,
        ...
        """
        Evaluate a (typically loaded) model on a dataset without updating weights.

        Computes link-prediction loss/accuracy plus the model's self-perception
        metrics (resonance, coherence, health) so a saved checkpoint can be
        sanity-checked before it's put back into service.
        ...
        Returns:
            Dict of metrics: loss, link_loss, accuracy, resonance, coherence, health
        """
        self.model.eval()
        ...
        with torch.no_grad():
            ...
            # Self-perception on the full graph
