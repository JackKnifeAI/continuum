...
class CCTTrainer:
    ...
    def evaluate(self,
        ...
        coherence, health, and capacity utilization.
        ...
        with torch.no_grad():
            ...
            # Self-perception pass over the full graph
            ...
            capacity = sp_out['self_state']['capacity_utilization'].item()
        ...
        print(f"  Accuracy      : {metrics['accuracy']:.4f}  ({(tp+tn)}/{n})")
...
def main():
    ...
    if args.evaluate:
        if model_path.exists():
            ...
            logger.info(f"Evaluation complete: F1={metrics['f1']:.4f}, resonance={metrics['resonance']:.4f}")
        else:
