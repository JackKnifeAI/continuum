...
def main():
    ...
    if args.evaluate:
        if model_path.exists():
            ...
            print(f"Avg Link Loss      : {total_link_loss / num_batches:.4f}")
            print(f"Link Accuracy      : {accuracy:.4f} ({correct}/{total})")
            print(f"Avg Resonance      : {total_resonance / num_batches:.3f}")
