...
class CCTTrainer:
    ...
    def evaluate(self,
        ...
        Mirrors the forward pass used in `train_epoch`, but runs under
        `torch.no_grad()` and additionally reports link-prediction accuracy.
        ...
        Returns:
            Dict of metrics: loss, link_loss, link_accuracy, resonance,
            coherence, health
        """
        self.model.eval()
        ...
        with torch.no_grad():
            ...
            # Self-perception on the full concept graph
...
def main():
    ...
    if args.evaluate:
        if model_path.exists():
            ...
            print(f"Link Accuracy: {metrics['link_accuracy']:.3f}")
