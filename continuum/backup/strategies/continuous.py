...
class ContinuousBackupStrategy(BackupStrategyBase):
    ...
    def get_base_backup_id(self) -> Optional[str]:
        """Get the base full backup ID this continuous stream builds upon."""
        return self._base_backup_id

    def set_base_backup(self, backup_id: str) -> None:
        """
        Set the base full backup that this continuous stream references.

        Args:
            backup_id: ID of the full backup this stream builds upon
        """
