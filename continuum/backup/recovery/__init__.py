...
async def _selective_restore_from_full(
    ...
    logger.info(f"Extracted {restored_tables} tables, {total_records} records from full backup")
...
async def _selective_restore_from_incremental(
    ...
    result.tables_restored = restored_tables
    result.records_restored = total_records
    logger.info(f"Applied incremental changes for {restored_tables} tables, {total_records} records")
