...
class QuantumInterface:
    ...
    async def _run_on_ibm_quantum(self, qc: Any, shots: int) -> Dict[str, int]:
        ...
        try:
            ...
            logger.warning(f"IBM Quantum submission failed ({e}) — falling back to AerSimulator")
