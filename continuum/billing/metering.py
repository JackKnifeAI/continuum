...
class UsageReporter:
    ...
    def __init__(
        ...
        # Maps tenant_id -> subscription_item_id for active metered subscriptions
        self._active_subscriptions: Dict[str, str] = {}

    def register_subscription(self, tenant_id: str, subscription_item_id: str) -> None:
        """Register an active metered subscription for background reporting."""
        self._active_subscriptions[tenant_id] = subscription_item_id
        logger.info(f"Registered subscription for {tenant_id}: {subscription_item_id}")
    ...
    def unregister_subscription(self, tenant_id: str) -> None:
        ...
        logger.info(f"Unregistered subscription for {tenant_id}")
        ...
        while True:
            ...
            for tenant_id, subscription_item_id in list(self._active_subscriptions.items()):
                try:
                    ...
                    logger.error(f"Background usage report failed for {tenant_id}: {e}")
