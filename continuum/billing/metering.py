...
class UsageReporter:
    ...
    def __init__(
        ...
        self._tenant_subscriptions: Dict[str, str] = {}  # tenant_id -> subscription_item_id
    ...
    def register_subscription(self, tenant_id: str, subscription_item_id: str) -> None:
        ...
        """
        self._tenant_subscriptions[tenant_id] = subscription_item_id
    ...
    def unregister_subscription(self, tenant_id: str) -> None:
        ...
        Args:
            tenant_id: Tenant identifier
        """
        self._tenant_subscriptions.pop(tenant_id, None)
    ...
    async def start_background_reporting(self) -> None:
        ...
        while True:
            ...
            for tenant_id, subscription_item_id in list(self._tenant_subscriptions.items()):
