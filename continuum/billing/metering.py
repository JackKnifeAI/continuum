    ...
    async def _flush_cache(self) -> None:
        ...
        if self.storage:
            try:
                ...
                logger.debug(f"Flushed {len(serializable)} usage entries to storage")
...
class UsageReporter:
    ...
    def __init__(
        ...
        # tenant_id -> subscription_item_id for active subscriptions
    ...
    def register_subscription(self, tenant_id: str, subscription_item_id: str) -> None:
        """Register a tenant's active subscription for background usage reporting."""
    ...
    def unregister_subscription(self, tenant_id: str) -> None:
        """Remove a tenant's subscription from background reporting (e.g., on cancel)."""
